...
#define HEAPSIZE_BYTES ((580 * 1024) - 3640)
#define HEAPSIZE_WORDS (HEAPSIZE_BYTES / sizeof(uint32_t))

// Define HEAP as a 32-bit array
uint32_t HEAP[HEAPSIZE_WORDS];
memzone_t* mainzone;
